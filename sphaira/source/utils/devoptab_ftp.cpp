...
private:
    ...
    std::pair<bool, long> ftp_quote(std::vector<std::string> commands, bool is_dir, std::vector<char>* response_data = nullptr);
...
std::pair<bool, long> Device::ftp_quote(std::vector<std::string> commands, bool is_dir, std::vector<char>* response_data) {
